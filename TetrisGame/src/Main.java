...
public class Main {
 ...
 void functions(Main t) throws IOException, InterruptedException {
 ...
 void handleredo(Main t) throws IOException, InterruptedException {
 ...
 void handleundo(Main t) throws IOException, InterruptedException {
     if (t.stack.empty()) {
         t.boardFunctions();
